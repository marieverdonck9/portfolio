...
import cart from "../assets/projects/CCL5_XCL1_CART.png";
import AI_binder from "../assets/projects/Insilico_generation_pMHC_binders.png";

export const projectInfo = [
  {
    name: "AI-enabled discovery of synthetic protein binders for targeted immunotherapy",
    date: "Aug 2025 - Present",
    link: "https://www.garciabeltranlab.org",
    skills: [
    ...
    featured: true,
    description:
      "Developing binders against intracellular tumor antigens presented as peptide-HLA complexes. I am building a pHLA binder design pipeline that integrates mass-spectrometry-based antigen discovery with structural prediction and generative AI, enabling scalable design of high-affinity binders for multiple HLA alleles and transforming them into versatile therapeutic formats such as CARs and bispecifics",
    imagePath: AI_binder,
  },
  {
    name: "Engineering CAR T cells to engage the endogenous immune system in solid tumors",
    date: "Jan 2025 - Aug 2025",
    link: "https://t-cells-treating-cancer.dana-farber.org",
    skills: [
    ...
    featured: true,
    description:
      "Designed CAR-T cells that actively remodel the tumor microenvironment by recruiting endogenous immune cells such as cDC1s. Using targeted knock-in of immunomodulatory transgenes in murine T cells, I evaluated how engineered signaling and immune-cell crosstalk influences therapeutic performance, reinforcing the potential of CAR-based therapies that function as immune network modulators.",
    imagePath: cart,
  },
  {
    ...
    featured: true,
    description:
      "Developed a high-throughput genome-editing pipeline to study how combinations of mutations shape adaptive fitness in S. cerevisiae. Work combined CRISPR engineering and NGS analysis to map genotype-to-phenotype relationships.",
  ...
  },
  {
    ...
    skills: ["Genomic Analysis", "Data Quality Control", "Bioinformatics"],
    description:
