export const projectInfo = [
  ...
  },
 {
    ...
    description: "Used transposons to introduce mutations in <span className="italic">E. coli</span> to alter the resistance characteristics of the target plasmid. The goal was to investigate the mutagenic capabilities of transposons and their broader scientific relevance.",
  },
 {
    ...
    skills: ["Genetic Manipulation", "Molecular Biology Techniques"],
    description: "Conducted site-directed mutagenesis to introduce specific genetic mutations in <span className="italic">Pseudomonas fluorescens</span>. The goal was to investigate genetic modification techniques, contributing to a deeper understanding of precise genetic alterations and their broader applications.",
  },
];
