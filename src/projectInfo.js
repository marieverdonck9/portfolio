export const projectInfo = [
  {
    ...
    description:
      'In my Master’s thesis, I delve into genetic mutations and their impact on adaptation in <span className="italic"> S. cerevisiae </span>. My main goal is to unravel the intricacies of the fitness landscape experienced by strains during the adaptation process. To achieve this, I am developing a specialized pipeline to introduce several mutations in yeast cells. By dissecting the genetic components that drive adaptation, I aim to gain a deeper understanding of how organisms evolve in response to changing environments, ultimately contributing valuable insights to the broader field of evolutionary biology.',
  },
  {
    name: 'Resistance development of <span className="italic">Pseudomonas aeruginosa</span> over the past half-century',
    date: "May 2023",
    ...
    description:
      'Investigated antibiotic resistance development in <span className="italic">Pseudomonas aeruginosa</span>. Using whole-genome analysis and next-generation sequencing, I compared strains isolated before and after 1940 to study the evolution of antibiotic resistance. The analysis focused on aminoglycoside and fluoroquinolone resistance mechanisms, examining the presence of aminoglycoside-modifying enzymes and mutations in key proteins.',
  },
  {
  ...
  {
    name: 'Antimicrobial production in nontoxigenic <span className="italic">Clostridium botulinum</span>',
    ...
    description:
      'In my Bachelor’s thesis, I explored the antimicrobial potential of three nontoxigenic <span className="italic">Clostridium botulinum</span> strains (1985, HA1, and ZO42). I identified bacteriocins, proteinaceous compounds with antibacterial properties, within these strains through whole genome sequence analysis. The study revealed highly potent compounds with distinct modes of action, shedding light on their potential applications as alternative antimicrobial agents.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Used transposons to introduce mutations in <span className="italic">E. coli</span> to alter the resistance characteristics of the target plasmid. The goal was to investigate the mutagenic capabilities of transposons and their broader scientific relevance.',
  },
  {
    ...
    skills: ["Genetic Manipulation", "Molecular Biology Techniques"],
    description:
      'Conducted site-directed mutagenesis to introduce specific genetic mutations in <span className="italic">Pseudomonas fluorescens</span>. The goal was to investigate genetic modification techniques, contributing to a deeper understanding of precise genetic alterations and their broader applications.',
  },
];
