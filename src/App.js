    ...
    <Router>
      ...
      <div className="min-h-screen bg-white text-slate-800">
        <header className="w-full sticky top-0 z-40 navbar-glass" role="banner">
          ...
          <div
            className="w-full navbar-accent-bar"
            aria-hidden="true"
          />
        ...
        <footer className="w-full border-t mt-12 bg-slate-50" role="contentinfo">
          <div className="container-centered px-6 py-8">
            <div className="flex flex-col md:flex-row justify-between gap-6 mb-6">
              <div>
                <div className="font-bold text-lg text-slate-900 mb-2">Marie Verdonck</div>
                <p className="text-sm text-slate-600 mb-3 max-w-md">
                  Translational immunologist engineering cancer immunotherapies through
                  genome editing and computational analysis.
                </p>
              ...
              <div>
                <div className="font-semibold text-sm text-slate-900 mb-3">Get in Touch</div>
